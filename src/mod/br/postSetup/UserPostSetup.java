...
public class UserPostSetup extends AbstractCfgFile<IGameOptions> {
    
    // ------------------------------------------------------------------------
    // Constructors
    //
	public UserPostSetup() {}
	
	// ========================================================================
	//  Abstract Methods
	//
	@Override protected String getFilePath () { return Rotp.jarPath(); }
	@Override protected String getFileName () { return "PostSetup.cfg"; }
	@Override protected String getSettingUserActionName () { return "POST SETUP ACTION"; }
