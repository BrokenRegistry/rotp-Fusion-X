...
class Abstract_EntryTest {

	Entry_Test_String entry  = new Entry_Test_String();
	Entry_Test_String origin = new Entry_Test_String();
	...
	void entry_Base_None() {
		assertEquals("xyz", new Entry_Test_String().set("abc").set("xyz").getUserEntry()
				, "should have been «xyz»");
	}
	
	@Test
	void entry_Base_String() {
		assertEquals("abc", new Entry_Test_String("abc").getUserEntry()
				, "should have been «abc»");
	}
	...
	@Test
	void set_String() {
		assertEquals("xyz", new Entry_Test_String("xxx").set("abc").set("xyz").getUserEntry()
				, "should have been «xyz»");
	}
	...
	class Entry_Test_String extends Abstract_Entry<String> {
	    // ==================================================
	    // Constructors
	    //
		/**
