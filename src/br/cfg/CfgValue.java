...
// */	
//public class CfgValue extends CfgEntry{
//	/**
...
//	 */
//	public CfgValue(String entry, DataType dataType) {
//		init(entry);
...
//	 * @param  dataType specified {@code DataType}
//	 */
//	public CfgValue(Double value, DataType dataType) {
//		init(value);
//		setDataType(dataType);
//	}
//	/**
...
//	 * @param  dataType specified {@code DataType}
//	 */
//	public CfgValue(Float value, DataType dataType) {
//		init(value);
//		setDataType(dataType);
//	}
//	/**
...
//	 * @param  dataType specified {@code DataType}
//	 */
//	public CfgValue(Long value, DataType dataType) {
//		init(value);
//		setDataType(dataType);
//	}
//	/**
...
//	 * @param  dataType specified {@code DataType}
//	 */
//	public CfgValue(Integer value, DataType dataType) {
//		init(value);
//		setDataType(dataType);
//	}
//	/**
...
//	 * @param  dataType specified {@code DataType}
//	 */
//	public CfgValue(Short value, DataType dataType) {
//		init(value);
//		setDataType(dataType);
//	}
//	/**
...
//	 * @param  dataType specified {@code DataType}
//	 */
//	public CfgValue(Byte value, DataType dataType) {
//		init(value);
//		setDataType(dataType);
//	}
//	/**
...
//	 * @param  dataType specified {@code DataType}
//	 */
//	public CfgValue(Boolean value, DataType dataType) {
//		init(value);
//		setDataType(dataType);
//	}
//	/**
...
//	 */
//	private CfgValue(
//			CfgEntry e, Long w, Double f, Boolean b
...
//		return Abstract_ToComment.toComment(toString());
//	}
//	/**
//     * Format the value as Comment
//	 * @return the {@code String} formated value
...
//			return whole; 
//		}
//		whole = CfgUtil.toLong(super.get());
//		if (whole == null) {
//			return onEmpty;
//		}
//		return  whole;
...
//			return bool; 
//		}
//		bool = CfgUtil.toBoolean(super.get());
//		if (bool == null) {
//			return onEmpty;
//		}
//		return bool;
...
//	 */
//	public static CfgValue nextRandom(CfgValue min, CfgValue max) {
//		if (min != null && max != null) {
//			if (min.getDataType() == DataType.WHOLE
//					|| max.getDataType() == DataType.WHOLE) {
//				return new CfgValue(nextRandomLong( min.toLong()
//													, max.toLong()+1L))
//									.setDataType(DataType.WHOLE);
//			}
//			return new CfgValue(nextRandomDouble( min.toDouble()
//												, max.toDouble()))
...
//	 */
//	public CfgValue validateMin(CfgValue min) {
...
//	 */
//	public CfgValue validateMax(CfgValue max) {
...
//	 * @return the biggest value or this if equal
//	 */
//	public  CfgValue validateMinMax(CfgValue min, CfgValue max) {
...
//	 */	
//	public static CfgValue max(CfgValue value1, CfgValue value2) {
...
//	 */
//	public static CfgValue min(CfgValue value1, CfgValue value2) {
//		// If one is null, return the other, return null if both are null
//		if (value1 == null) {
//			return value2.clone();
//		}
...
//	 */
// 	public CfgValue setDataType(DataType dataType) {
// 		if (dataType == null) {
...
//	 */
//	@Override
//	public CfgValue set(String entry, Boolean caseSensitive) {
//		reset();
...
//	 * @return this for chaining purpose	 */
//	@Override
//	public CfgValue set(String entry) {
//		reset();
//		init(entry);
//		return this;
//	}
...
//	 */
//	@Override
//	public CfgValue set(CfgEntry entry, Boolean caseSensitive) {
//		reset();
//		init(entry, caseSensitive);
//		return this;
//	}
...
//	 */
//	@Override
//	public CfgValue set(CfgEntry entry) {
//		reset();
//		init(entry);
//		return this;
//	}
...
//	 * @return this for chaining purpose
//	 */
//	public CfgValue set(Double value) {
//		reset();
//		init(value);
//		return this;
//	}
...
//	 * @return this for chaining purpose
//	 */
//	public CfgValue set(Float value) {
//		reset();
//		init(value);
//		return this;
//	}
...
//	 * @return this for chaining purpose
//	 */
//	public CfgValue set(Long value) {
//		reset();
//		init(value);
//		return this;
//	}
...
//	 * @return this for chaining purpose
//	 */
//	public CfgValue set(Integer value) {
//		reset();
//		init(value);
//		return this;
//	}
...
//	 * @return this for chaining purpose
//	 */
//	public CfgValue set(Short value) {
//		reset();
//		init(value);
//		return this;
//	}
...
//	 * @return this for chaining purpose
//	 */
//	public CfgValue set(Byte value) {
//		reset();
//		init(value);
//		return this;
//	}
...
//	 * @return this for chaining purpose
//	 */
//	public CfgValue set(Boolean value) {
//		reset();
//		init(value);
//		return this;
//	}
...
//	 */
//	@Override
//	public CfgValue removeComment() {
//		set(Abstract_ToComment.removeComment(getCfg_Entry()));
//		return this;
//	}
//	// ==================================================
...
//		setOrigin(DataType.STRING);
//	}
//	private void init(CfgEntry source) {
//		super.set(source);
//		setOrigin(DataType.STRING);
//	}
//	private void init(CfgEntry source, Boolean caseSensitive) {
//		super.set(source, caseSensitive);
//		setOrigin(DataType.STRING);
//	}
