...
class Cfg_ValueTest {
	...
	@Test
	void testToComment() {
		assertEquals("# ", new Cfg_Value().toComment()
				, "should have been: «# »");	
		assertEquals("# abc", new Cfg_Value("abc").toComment()
				, "should have been: «# abc»");	
		assertEquals("# YES", new Cfg_Value(true).toComment()
				, "should have been: «# YES»");	
		assertEquals("# 88.9", new Cfg_Value(88.9).toComment()
				, "should have been: «# 88.9»");	
		assertEquals("# 88", new Cfg_Value(88L).toComment()
				, "should have been: «# 88.9»");	
		assertEquals("# 89", new Cfg_Value(88.9, DataType.WHOLE).toComment()
				, "should have been: «# 89»");	
		assertEquals("# 88.0", new Cfg_Value(88L, DataType.FLOATING).toComment()
				, "should have been: «# 88.0»");	
	}
	@Test
	void testToPrint() {
